...
// todo: implement a 'stack' that can track [IntStr -> VID/MTypeID]
//  - each Frame maps IntStr IDs to a mval::VID or mtype::MTypeID
...
namespace monomorphizer::stack {
    ...
    mval::VID lookup_v_in_stack(Stack* stack, intern::IntStr int_str_id);
