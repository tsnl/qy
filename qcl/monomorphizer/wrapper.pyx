...
cdef:
    ...
    DefID w_define_total_const_value(char* mv_def_name, ValueID value_id, bint is_global):
        return define_total_const_value(mv_def_name, value_id, is_global)
